...
module.exports = function(router) {
    ...
    var client = nodemailer.createTransport({
        service: 'Gmail',
        auth: {
            user: 'bumperwash@gmail.com', // Your email address
            pass: 'Bumper2Bumper' // Your password
        },
    ...
    router.post('/contact', function(req, res){
        ...
        var email = {
            ...
            to: ['bumperwash@gmail.com', ''],// list of receivers
            subject: req.body.subject, // Subject line
            html: `<p>You have a new contact request from bumperwash.com</p>
    ...
    router.post('/enroll', function(req, res){
        ...
        var email = {
            from: '"BumperWash staff", bumperwash@gmail.com', // sender address
            to: ['bumperwash@gmail.com', ''],// list of receivers
            subject: 'New enrolment request', // Subject line
            html: `<p>You have a new enroll request from bumperwash.com</p>
                <h3>Details </h3>
                <ul><li>Name: ${req.body.name}</li>
                <li>Phone: ${req.body.mobile}</li>
